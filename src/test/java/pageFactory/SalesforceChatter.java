...
public class SalesforceChatter {
 ...
 //   WebDriverWait wait = new WebDriverWait(driver, 10);
    ...
    @FindBy(css="input[class='inputField cuf-pollChoiceField input']:nth-child(1)")
    WebElement ChatterPollChoice1field;
    
    @FindBy(css="input[class='inputField cuf-pollChoiceField input']:nth-child(2)")
...
//		wait.until(ExpectedConditions.elementToBeClickable(ChatterQuestionDescField));
